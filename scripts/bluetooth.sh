...
# Non bindé : Super+B passe par bluetooth-manager.sh (UI blueman, wrapper
# anti-crash scan BLE). Ce script reste disponible pour la CLI.
set -u

cmd="${1:-}"

# Si bluetoothctl est absent (requirements bluez-utils) → message explicite
